...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../qsys_nios2_ddr3.sopcinfo
...
# Design Name 
# setting SOPC_NAME is qsys_nios2_ddr3
SOPC_NAME := qsys_nios2_ddr3
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x10041000
SOPC_SYSID_FLAG += --sidp=0x10041000
ELF_PATCH_FLAG  += --sidp 0x10041000

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1520607111
SOPC_SYSID_FLAG += --timestamp=1520607111
ELF_PATCH_FLAG  += --timestamp 1520607111
