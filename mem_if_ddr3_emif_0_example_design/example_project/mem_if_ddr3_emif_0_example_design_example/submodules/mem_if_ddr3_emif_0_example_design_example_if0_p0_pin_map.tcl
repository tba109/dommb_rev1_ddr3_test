		...
		if {[array size results_array] == 1} {
			...
			if {[array size results_array] == 1} {
				...
				if {[array size pll_clk_results_array] == 1} {
					...
					mem_if_ddr3_emif_0_example_design_example_if0_p0_traverse_fanin_up_to_depth $pll_inclk_id mem_if_ddr3_emif_0_example_design_example_if0_p0_is_node_type_pin clock results_array 20
					if {[array size results_array] == 1} {
						set pin_id [lindex [array names results_array] 0]
						set result $pin_id
					} else {
...
proc mem_if_ddr3_emif_0_example_design_example_if0_p0_get_acv_read_offset { period dqs_phase dqs_period } {
...
proc mem_if_ddr3_emif_0_example_design_example_if0_p0_traverse_to_clock_phase_select {pin msg_list_name} {
	...
	if {$pin != ""} {
		...
		set cps_id_list [mem_if_ddr3_emif_0_example_design_example_if0_p0_traverse_atom_path $pin_id -1 $pin_to_cps_path]
...
proc mem_if_ddr3_emif_0_example_design_example_if0_p0_traverse_to_clkbuf {pin msg_list_name} {
	upvar 1 $msg_list_name msg_list
	set result ""
	if {$pin != ""} {
		set pin_id [get_atom_node_by_name -name $pin]
		...
		set clkbuf_id_list [mem_if_ddr3_emif_0_example_design_example_if0_p0_traverse_atom_path $pin_id -1 $pin_to_clkbuf_path]
...
# ----------------------------------------------------------------
	...
	if {$pin_report_id != -1} {
		set pin_name_column [mem_if_ddr3_emif_0_example_design_example_if0_p0_get_report_column $pin_report_id "Pin Name/Usage"]
		set info_column [mem_if_ddr3_emif_0_example_design_example_if0_p0_get_report_column $pin_report_id "I/O Type"]
		if {$pin_name_column == 0 && 0} {
			set row_index [get_report_panel_row_index -id $pin_report_id $target_pin]
			if {$row_index != -1} {
				set row [get_report_panel_row -id $pin_report_id -row $row_index]
		...
		if {$pin_report_id != -1} {
			...
			set report_rows [get_number_of_rows -id $pin_report_id]
			set pin_name_column [mem_if_ddr3_emif_0_example_design_example_if0_p0_get_report_column $pin_report_id "Name"]
			set info_column [mem_if_ddr3_emif_0_example_design_example_if0_p0_get_report_column $pin_report_id "I/O Edge"]
...
proc mem_if_ddr3_emif_0_example_design_example_if0_p0_get_ddr_pins { instname allpins } {
	...
	# AFI PHY CLOCK PLL
	set pll_afi_phy_clock_id [mem_if_ddr3_emif_0_example_design_example_if0_p0_get_output_clock_id $pins(afi_phy_ck_pins) "AFI PHY CK" msg_list]
	if {$pll_afi_phy_clock_id == -1} {
		foreach {msg_type msg} $msg_list {
			post_message -type $msg_type "mem_if_ddr3_emif_0_example_design_example_if0_p0_pin_map.tcl: $msg"
		}
		post_message -type critical_warning "mem_if_ddr3_emif_0_example_design_example_if0_p0_pin_map.tcl: Failed to find PLL clock for pins [join $pins(afi_phy_ck_pins)]"
	} else {
		set pll_afi_phy_clock [mem_if_ddr3_emif_0_example_design_example_if0_p0_get_pll_clock_name $pll_afi_phy_clock_id]
	}
...
proc mem_if_ddr3_emif_0_example_design_example_if0_p0_dump_static_pin_map { ddr_db_par filename } {
	...
	foreach instname $instnames {
		...
		mem_if_ddr3_emif_0_example_design_example_if0_p0_static_map_expand_string $FH pins pll_afi_phy_clock
