...
proc mem_if_ddr3_emif_0_example_design_example_if0_p0_perform_flexible_write_launch_timing_analysis {opcs opcname inst family scale_factors_name interface_type max_package_skew dll_length period pin_array_name timing_parameters_array_name summary_name MP_name IP_name board_name} {
	...
	if {($result == 1)} {
		...
		foreach dqpins $pins(q_groups) {
			...
			set cps_name [mem_if_ddr3_emif_0_example_design_example_if0_p0_traverse_to_clock_phase_select $dqspin msg_list]
			...
			foreach dqpin $dqdmpins {
				...
				set cps_name [mem_if_ddr3_emif_0_example_design_example_if0_p0_traverse_to_clock_phase_select $dqpin msg_list]
...
proc mem_if_ddr3_emif_0_example_design_example_if0_p0_perform_flexible_read_capture_timing_analysis {opcs opcname inst family scale_factors_name io_std interface_type max_package_skew dqs_phase period all_dq_pins pin_array_name timing_parameters_array_name summary_name MP_name IP_name board_name fpga_name} {
	...
	if {$IP(read_deskew_mode) == "dynamic"} {
		...
		set offset_from_90 [mem_if_ddr3_emif_0_example_design_example_if0_p0_get_acv_read_offset $period $dqs_phase $dqs_period]
		if {$IP(num_ranks) == 1} {
...
proc mem_if_ddr3_emif_0_example_design_example_if0_p0_perform_ac_analyses {opcs opcname inst scale_factors_name pin_array_name timing_parameters_array_name summary_name IP_name} {
	...
	set clk_max [mem_if_ddr3_emif_0_example_design_example_if0_p0_max_in_collection [get_path -rise_from $pll_clock -rise_to $clk_periphery_nodes] "arrival_time"]
	if {$clk_max <= 0} {set clk_max -9999}
	set clk_min [mem_if_ddr3_emif_0_example_design_example_if0_p0_max_in_collection [get_path -rise_from $pll_clock -rise_to $clk_periphery_nodes -min_path] "arrival_time"]
	...
	foreach ac_pin $ac_pins {
		...
		set ac_clk_phase_select_node [mem_if_ddr3_emif_0_example_design_example_if0_p0_traverse_to_clkbuf $ac_pin msg_list]
		set ac_periphery_node ${ac_clk_phase_select_node}|outclk

		set ac_max  [mem_if_ddr3_emif_0_example_design_example_if0_p0_max_in_collection [get_path -rise_from $pll_clock -${rise_or_fall_to} $ac_periphery_node] "arrival_time"]
		if {$ac_max <= 0} {set ac_max -9999}
		set ac_min  [mem_if_ddr3_emif_0_example_design_example_if0_p0_max_in_collection [get_path -rise_from $pll_clock -${rise_or_fall_to} $ac_periphery_node -min_path] "arrival_time"]
		if {$ac_min <= 0} {set ac_min 9999}
		set extra_ccpr [mem_if_ddr3_emif_0_example_design_example_if0_p0_round_3dp [expr ($clk_max - $clk_min + 0.5*($ac_max - $ac_min))/2.0]]
		...
		set ACperiphery_min_delay [mem_if_ddr3_emif_0_example_design_example_if0_p0_min_in_collection $ACperiphery_min "arrival_time"]
		set ACperiphery_max_delay [mem_if_ddr3_emif_0_example_design_example_if0_p0_max_in_collection $ACperiphery_max "arrival_time"]
		set aiot_delay [mem_if_ddr3_emif_0_example_design_example_if0_p0_round_3dp [expr [mem_if_ddr3_emif_0_example_design_example_if0_p0_get_rise_aiot_delay [lindex $ac_pin 0]] * 1e9]]
	...
	lappend ac_summary [list "  Extra common clock and spatial correlation pessimism removal" [mem_if_ddr3_emif_0_example_design_example_if0_p0_format_3dp [expr $setup_slack - $default_setup_slack]] [mem_if_ddr3_emif_0_example_design_example_if0_p0_format_3dp [expr $hold_slack - $default_hold_slack]]]
	...
	foreach dqs_pin $pins(dqs_pins) {
		...
		set dqs_pin_setup_slack [mem_if_ddr3_emif_0_example_design_example_if0_p0_min_in_collection_to_name $dqs_paths_setup "slack" $dqs_pin]
		set dqs_pin_hold_slack  [mem_if_ddr3_emif_0_example_design_example_if0_p0_min_in_collection_to_name $dqs_paths_hold  "slack" $dqs_pin]
		
		set dqs_clk_phase_select_node [mem_if_ddr3_emif_0_example_design_example_if0_p0_traverse_to_clock_phase_select $dqs_pin msg_list]
		set dqs_periphery_node ${dqs_clk_phase_select_node}|clkout 

		set dqs_max  [mem_if_ddr3_emif_0_example_design_example_if0_p0_max_in_collection [get_path -rise_from $pll_clock -rise_to $dqs_periphery_node] "arrival_time"]
		if {$dqs_max <= 0} {set dqs_max -9999}
		set dqs_min  [mem_if_ddr3_emif_0_example_design_example_if0_p0_max_in_collection [get_path -rise_from $pll_clock -rise_to $dqs_periphery_node -min_path] "arrival_time"]
		if {$dqs_min <= 0} {set dqs_min 9999}

		set extra_ccpr [mem_if_ddr3_emif_0_example_design_example_if0_p0_round_3dp [expr ($clk_max - $clk_min + $dqs_max - $dqs_min)/2.0]]
	...
	lappend dqs_summary [list "  Standard DQS vs CK" [mem_if_ddr3_emif_0_example_design_example_if0_p0_format_3dp $default_dqs_setup_slack] [mem_if_ddr3_emif_0_example_design_example_if0_p0_format_3dp $default_dqs_hold_slack]]
	lappend dqs_summary [list "  Extra common clock pessimism removal" [mem_if_ddr3_emif_0_example_design_example_if0_p0_format_3dp [expr $dqs_setup_slack - $default_dqs_setup_slack]] [mem_if_ddr3_emif_0_example_design_example_if0_p0_format_3dp [expr $dqs_hold_slack - $default_dqs_hold_slack]]]
	...
	set fcolour [mem_if_ddr3_emif_0_example_design_example_if0_p0_get_colours $dqs_setup_slack $dqs_hold_slack] 
	add_row_to_table -id $dqs_panel_id [list "DQS vs CK" [mem_if_ddr3_emif_0_example_design_example_if0_p0_format_3dp $dqs_setup_slack] [mem_if_ddr3_emif_0_example_design_example_if0_p0_format_3dp $dqs_hold_slack]] -fcolor $fcolour
	lappend summary [list $opcname 0 "DQS vs CK ($opcname)" [mem_if_ddr3_emif_0_example_design_example_if0_p0_format_3dp $dqs_setup_slack] [mem_if_ddr3_emif_0_example_design_example_if0_p0_format_3dp $dqs_hold_slack]]
...
proc mem_if_ddr3_emif_0_example_design_example_if0_p0_perform_resync_timing_analysis {opcs opcname inst fbasename family scale_factors_name io_std interface_type period pin_array_name timing_parameters_array_name summary_name MP_name IP_name board_name fpga_name SSN_name} {
	...
	set max_dqs_common_to_fifo [mem_if_ddr3_emif_0_example_design_example_if0_p0_max_in_collection [get_path -from $dqs_pins -to $fifo -nworst 1] "arrival_time"]
...
proc mem_if_ddr3_emif_0_example_design_example_if0_p0_perform_flexible_postamble_timing_analysis {opcs opcname instname scale_factors_name family period dll_length interface_type tJITper tJITdty tDCD DQSpathjitter pin_array_name timing_parameters_array_name summary_name  MP_name IP_name SSN_name board_name ISI_parameters_name} {
	...
	set mem_clock_delay_max [mem_if_ddr3_emif_0_example_design_example_if0_p0_max_in_collection [get_path -rise_from $pins(pll_write_clock) -rise_to $pins(ck_pins)] "arrival_time"]
	set mem_clock_delay_min [mem_if_ddr3_emif_0_example_design_example_if0_p0_min_in_collection [get_path -rise_from $pins(pll_write_clock) -rise_to $pins(ck_pins) -min_path] "arrival_time"]


	set dqs_delay_max  [mem_if_ddr3_emif_0_example_design_example_if0_p0_max_in_collection [get_path -rise_from $pins(dqs_pins) -fall_to *POSTAMBLE_DFF] "arrival_time"]
	set dqs_delay_min  [mem_if_ddr3_emif_0_example_design_example_if0_p0_min_in_collection [get_path -rise_from $pins(dqs_pins) -fall_to *POSTAMBLE_DFF -min_path] "arrival_time"]	
	set ck_pin_buffer_delay [mem_if_ddr3_emif_0_example_design_example_if0_p0_round_3dp [expr [mem_if_ddr3_emif_0_example_design_example_if0_p0_get_min_aiot_delay [lindex $pins(ck_pins) 0]] * 1e9]]
	...
	set clock_delay_max [mem_if_ddr3_emif_0_example_design_example_if0_p0_max_in_collection [get_path -rise_from $pins(pll_write_clock) -rise_to $dqsenableextend_regs] "arrival_time"]
	set clock_delay_min [mem_if_ddr3_emif_0_example_design_example_if0_p0_min_in_collection [get_path -rise_from $pins(pll_write_clock) -rise_to $dqsenableextend_regs -min_path] "arrival_time"]
	set t11_delay_max [mem_if_ddr3_emif_0_example_design_example_if0_p0_max_in_collection [get_path -rise_from $dqsenableextend_regs -fall_to *POSTAMBLE_DFF] "arrival_time"]
	set t11_delay_min [mem_if_ddr3_emif_0_example_design_example_if0_p0_min_in_collection [get_path -rise_from $dqsenableextend_regs -fall_to *POSTAMBLE_DFF -min_path] "arrival_time"]
