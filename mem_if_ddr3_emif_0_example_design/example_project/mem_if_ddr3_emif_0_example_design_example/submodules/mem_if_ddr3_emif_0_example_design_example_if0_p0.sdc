...
foreach { inst } $instances {
	...
	# HR PHY clock
	set local_pll_afi_phy_clk [ mem_if_ddr3_emif_0_example_design_example_if0_p0_get_or_add_clock_vseries \
	...
	# A/C clock
	set local_pll_addr_cmd_clk [ mem_if_ddr3_emif_0_example_design_example_if0_p0_get_or_add_clock_vseries \
		-target $pll_ac_clock \
		-suffix "addr_cmd_clk" \
		-source $pll_ref_clock \
		-multiply_by $::GLOBAL_mem_if_ddr3_emif_0_example_design_example_if0_p0_pll_mult(PLL_ADDR_CMD_CLK) \
		-divide_by $::GLOBAL_mem_if_ddr3_emif_0_example_design_example_if0_p0_pll_div(PLL_ADDR_CMD_CLK) \
		-phase $::GLOBAL_mem_if_ddr3_emif_0_example_design_example_if0_p0_pll_phase(PLL_ADDR_CMD_CLK) ]
	...
	set mem_factor [expr double($::GLOBAL_mem_if_ddr3_emif_0_example_design_example_if0_p0_pll_mult(PLL_MEM_CLK)) / $::GLOBAL_mem_if_ddr3_emif_0_example_design_example_if0_p0_pll_div(PLL_MEM_CLK)]
	set avl_factor [expr double($::GLOBAL_mem_if_ddr3_emif_0_example_design_example_if0_p0_pll_mult(PLL_NIOS_CLK)) / $::GLOBAL_mem_if_ddr3_emif_0_example_design_example_if0_p0_pll_div(PLL_NIOS_CLK)]
	...
	foreach { ck_pin } $ck_pins { 
		set_output_delay -add_delay -clock [get_clocks $ck_pin] -max [mem_if_ddr3_emif_0_example_design_example_if0_p0_round_3dp [expr $t(CK) - $t(DQSS)*$t(CK) - $board(minCK_DQS_skew) ]] $dqs_pins
		set_output_delay -add_delay -clock [get_clocks $ck_pin] -min [mem_if_ddr3_emif_0_example_design_example_if0_p0_round_3dp [expr $t(DQSS)*$t(CK) - $board(maxCK_DQS_skew) ]] $dqs_pins
	...
	set ac_fr_phase_mod_360 [expr round(2*$::GLOBAL_mem_if_ddr3_emif_0_example_design_example_if0_p0_pll_phase(3)) % 360]
	set ck_fr_phase_mod_360 [expr round($::GLOBAL_mem_if_ddr3_emif_0_example_design_example_if0_p0_pll_phase(1)) % 360]
