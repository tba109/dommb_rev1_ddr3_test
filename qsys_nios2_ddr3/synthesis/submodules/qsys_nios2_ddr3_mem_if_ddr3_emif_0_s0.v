// qsys_nios2_ddr3_mem_if_ddr3_emif_0_s0.v
...
`timescale 1 ps / 1 ps
module qsys_nios2_ddr3_mem_if_ddr3_emif_0_s0 (
	...
	rw_manager_ddr3 #(
		...
		.HCX_COMPAT_MODE                      (0),
		.DEVICE_FAMILY                        ("CYCLONEV"),
		.AC_ROM_INIT_FILE_NAME                ("qsys_nios2_ddr3_mem_if_ddr3_emif_0_s0_AC_ROM.hex"),
		.INST_ROM_INIT_FILE_NAME              ("qsys_nios2_ddr3_mem_if_ddr3_emif_0_s0_inst_ROM.hex"),
	...
	altera_mem_if_sequencer_mem_no_ifdef_params #(
		...
		.AVL_SYMBOL_WIDTH (8),
		.MEM_SIZE         (23552),
		.INIT_FILE        ("qsys_nios2_ddr3_mem_if_ddr3_emif_0_s0_sequencer_mem.hex"),
		.RAM_BLOCK_TYPE   ("AUTO")
	) sequencer_mem (
	...
	qsys_nios2_ddr3_mem_if_ddr3_emif_0_s0_mm_interconnect_0 mm_interconnect_0 (
	...
	qsys_nios2_ddr3_mem_if_ddr3_emif_0_s0_irq_mapper irq_mapper (
		.clk        (avl_clk),                       //       clk.clk
