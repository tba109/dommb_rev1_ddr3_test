...
lappend arg_list "--component-param=SEQ_ROM=qsys_nios2_ddr3_mem_if_ddr3_emif_0_s0_sequencer_mem.hex"
lappend arg_list "--component-param=RAM_BLOCK_TYPE=AUTO"
lappend arg_list "--component-param=AC_ROM_INIT_FILE_NAME=qsys_nios2_ddr3_mem_if_ddr3_emif_0_s0_AC_ROM.hex"
lappend arg_list "--component-param=INST_ROM_INIT_FILE_NAME=qsys_nios2_ddr3_mem_if_ddr3_emif_0_s0_inst_ROM.hex"
...
lappend arg_list "--output-name=qsys_nios2_ddr3_mem_if_ddr3_emif_0_s0"
lappend arg_list "--system-info=DEVICE_FAMILY=CYCLONEV"
lappend arg_list "--report-file=sopcinfo:qsys_nios2_ddr3_mem_if_ddr3_emif_0_s0.sopcinfo"
lappend arg_list "--report-file=txt:qsys_nios2_ddr3_mem_if_ddr3_emif_0_s0_seq_ipd_report.txt"
lappend arg_list "--file-set=SIM_VERILOG"
catch { eval [concat [list exec "/home/tyler/altera/16.0/quartus/sopc_builder/bin/ip-generate" --component-name=qsys_sequencer_110] $arg_list] } temp
puts $temp
